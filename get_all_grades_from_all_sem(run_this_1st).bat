@echo off
REM HCMUT All Grades Fetcher - Fetches all grades from danh-sach-diem-hoc-ky-mon-hoc API
...
powershell -ExecutionPolicy Bypass -File "%SCRIPT_DIR%get_all_grades.ps1" -AuthToken "%AUTH_TOKEN%" -Cookie "%COOKIE%" -OutputFile "%OUTPUT_FILE%" > fetch_result.json 2>error.log
